...
import com.hjh.aop.advice.AfterReturnAdvice;
import com.hjh.aop.advice.MethodBeforeAdvice;
import com.hjh.aop.advice.MethodSurroundAdvice;
    ...
    public Object invoke() throws Throwable {
        if (i < this.advices.size()) {
            ...
            if (advice instanceof MethodBeforeAdvice) {
                ...
                ((AfterReturnAdvice) advice).afterReturn(returnValue, method, args, target);
                return returnValue;
            }
            return this.invoke();
        } else {
